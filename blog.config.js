...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    'cf5b1a45c4174328a40a041a5498284f',
  ...
  GREETING_WORDS:
    ...
    'Hi，我是一个运营, Hi，我是一个打工人🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '意佰启潮', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '专业京东20年', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://yibai.vercel.app/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '运营, 推广, 京东, 淘宝, 代运营, 经验分享, 技术交流, 指数换算', // 网站关键词 英文逗号隔开
  ...
  POST_PREVIEW_LINES: process.env.NEXT_PUBLIC_POST_POST_PREVIEW_LINES || 20, // 预览博客行数
  ...
  COMMENT_GISCUS_REPO: process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO || 'MINIshizhu/NotionNext', // 你的Github仓库名 e.g 'tangly1024/NotionNext'
  COMMENT_GISCUS_REPO_ID: process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO_ID || 'R_kgDOLKX3eA', // 你的Github Repo ID e.g ( 設定完 giscus 即可看到 )
  COMMENT_GISCUS_CATEGORY_ID:
    process.env.NEXT_PUBLIC_COMMENT_GISCUS_CATEGORY_ID || 'DIC_kwDOLKX3eM4Ccu76', // 你的Github Discussions 內的 Category ID ( 設定完 giscus 即可看到 )
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || '意佰启潮', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
